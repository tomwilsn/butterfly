 ...
 */
@Component
public class PlayerData2RequestHandler extends BaseRequestHandler {

    private final Logger LOG = LogManager.getLogger(PlayerData2RequestHandler.class);
    ...
    public PlayerData2RequestHandler(final ButterflyUserDao userDao, final CardDao cardDao, final ProfileDao profileDao,
    ...
    public Object handleRequest(final Element requestBody, final Request request, final Response response) {
        ...
        if (requestMethod.equals("usergamedata_advanced")) {
            final String mode = XmlUtils.strAtPath(requestBody, "/playerdata_2/data/mode");
            final String refid = XmlUtils.strAtPath(requestBody, "/playerdata_2/data/refid");
            final String shopArea = XmlUtils.strAtPath(requestBody, "/playerdata_2/data/shoparea");
            ...
            if (mode.equals("userload")) {
                ...
                int loadFlag = XmlUtils.intAtPath(requestBody, "/playerdata_2/data/loadflag");
                ...
                return this.handleGhostLoadRequest(XmlUtils.intAtPath(requestBody, "/playerdata_2/data/ghostid"), request, response);
    ...
    private Object handleUserGameDataRecvRequest(final Element requestBody, final Request request, final Response response) {
        ...
        final int recvNum = XmlUtils.intAtPath(requestBody, "/playerdata_2/data/recv_num");
        final String recvCsv = XmlUtils.strAtPath(requestBody, "/playerdata_2/data/recv_csv");
    ...
    private Object handleUserGameDataSendRequest(final Element requestBody, final Request request, final Response response) {
        ...
        final NodeList valueNodes = XmlUtils.nodesAtPath(requestBody, "/playerdata_2/data/record/d");
    ...
    private Object handleUserSaveRequest(final Element requestBody, final Request request, final Response response) {
        ...
        final Element dataNode = (Element) XmlUtils.nodeAtPath(requestBody, "/playerdata_2/data");
